...
data['X7'] = data['X7'].astype('category').cat.codes
data['X8'] = data['X8'].astype('category').cat.codes
data['X9'] = data['X9'].astype('category').cat.codes
data['X10'] = data['X10'].astype('category').cat.codes
data['X12'] = data['X12'].astype('category').cat.codes
