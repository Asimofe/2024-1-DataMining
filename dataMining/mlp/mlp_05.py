'''
mlp_02.py에서 차원축소(3차원, pca)로 변경

Test Accuracy: 0.850817236255572
Classification Report:
               precision    recall  f1-score   support

         0.0       0.91      0.78      0.84      1707
         1.0       0.80      0.92      0.86      1658

    accuracy                           0.85      3365
   macro avg       0.86      0.85      0.85      3365
weighted avg       0.86      0.85      0.85      3365
'''
import pandas as pd
import numpy as np
import torch
