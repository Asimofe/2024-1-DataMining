...
Test Accuracy: 0.8184249628528975
Classification Report:
               precision    recall  f1-score   support

         0.0       0.89      0.73      0.80      1707
         1.0       0.77      0.91      0.83      1658

    accuracy                           0.82      3365
   macro avg       0.83      0.82      0.82      3365
weighted avg       0.83      0.82      0.82      3365
'''
...
# 데이터 로드 및 전처리
file_path = 'data/purchase_train.csv'
...
scheduler = StepLR(optimizer, step_size=30, gamma=0.1)  # 30 에포크마다 학습률을 10%로 감소
